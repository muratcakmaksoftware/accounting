...
@section('title', 'Ödeme Metotları Çöp Kutusu')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('payment_method_types.index') }}">Ödeme Metotları Birimleri</a></li>
    <li class="breadcrumb-item active">Ödeme Metotları Çöp Kutusu</li>
@endsection
    ...
    <script>
        $(document).ready(function () {
            $('#main-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('payment_method_types.trashed_datatables') }}',
                columns: [
