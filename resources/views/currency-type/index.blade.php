...
@section('breadcrumb')
    <li class="breadcrumb-item">Para Birimleri</li>
@endsection

@section('content')
    <a href="{{ route('currency_types.create') }}" class="button-floating"><i class="fa fa-plus"></i></a>
    ...
    <script>
        $(document).ready(function () {
            $('#main-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('currency_types.datatables') }}',
                columns: [
